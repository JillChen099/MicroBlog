# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-08-03 10:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article_type_id', models.IntegerField(choices=[(1, b'Python'), (2, b'Linux'), (3, b'Shell'), (4, b'\xe7\xbd\x91\xe7\xbb\x9c\xe5\xae\x89\xe5\x85\xa8')], default=None)),
            ],
        ),
        migrations.CreateModel(
            name='Article2Tag',
        ...
        migrations.AddField(
            model_name='article',
            name='category',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='repository.Category', verbose_name=b'\xe6\x96\x87\xe7\xab\xa0\xe5\x88\x86\xe7\xb1\xbb'),
        ),
        migrations.AddField(
            model_name='article',
            name='tags',
